...
const PRODUCTS = [
  ...
  },
  {
    ...
    caption:
      'la première messagerie et agenda open-source  sécurisés de l’État',
    description:
        ...
        {PRODUCTS.map(
          (
            ...
            <div className="flex gap-6 flex-col md:flex-row" key={name}>
              <div
                className={
                  'md:w-1/2 ' + (index % 2 === 0 ? 'md:order-1' : 'md:order-2')
                }
              >
                <div className="flex items-center gap-4">
                  ...
                  <a href={url} target="_blank">
                    <h3 className="text-xl sm:text-2xl text-blue-1 font-bold hover:underline">
                      <span className="font-extrabold">{name}</span>, {caption}
                    </h3>
                  </a>
                </div>
              ...
              <div
                className={
                  'md:w-1/2 ' + (index % 2 === 0 ? 'md:order-2' : 'md:order-1')
                }
              >
