  ...
  return (
    <div>
      <div className={containerClasses}>
        ...
        <div className={`flex items-end gap-4 mt-10 md:mt-0 align-stretch items-between mb-8 transition-all duration-300 ease-in-out ${isAnimating ? 'fade-out' : 'fade-in'}`}>
          {currentTestimonial.avatar?.src && (
            <Image
              src={`/assets/products/${currentTestimonial.avatar.src}`}
              alt={currentTestimonial.avatar.alt || currentTestimonial.author || ''}
              width={48}
              height={48}
          ...
          <div className="min-w-[200px]">
            {currentTestimonial.author && (
              <p className="text-gray-850 text-base font-medium">{currentTestimonial.author}</p>
            )}
