...
export const BlockHero : React.FC<{ productContent: ProductContent; slug: string }> = ({ productContent, slug }) => {
  ...
  return (
    <div className="w-[100%] max-w-[1200px] mx-auto mt-[100px] md:mt-[140px] overflow-hidden md:overflow-visible">
     <div className="md:flex gap-8 md:justify-between mb-8 md:mb-[74px] px-6 md:px-0">
     <div className="text-left md:max-w-[836px] relative z-10">
          ...
          {productContent?.hero?.links && Array.isArray(productContent.hero.links) && productContent.hero.links.length > 0 ? (
          ...
          <span className='text-gray-550'>
            <a className="text-gray-550 underline underline-offset-2" href="https://grist.numerique.gouv.fr/o/docs/forms/3kzLTwDzfAvJogt5SLXmwb/53" target='_blank'>Inscrivez-vous</a>
