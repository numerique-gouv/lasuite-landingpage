    ...
    <div className="max-w-container w-full mx-auto px-3 xl:px-0">
      <div className="md:gap-8">
        <div className="mb-8 md:mb-12 md:order-first px-3 md:px-0 pt-12 md:pt-0">
          ...
          <p
            className="text-gray-550 text-sm md:text-lg"
...
const AccordionItem: FC<{
  ...
  return (
    <div
      className={`border-greyscale-200 hover:bg-gray-050 transition-colors overflow-hidden
    ...
    >
      ...
      >
        ...
        <span
          className={`transition-transform ml-2 text-gray-550 ${open ? 'rotate-180' : ''}`}
        >
