...
export const Decisions: React.FC<DecisionsData> = ({ title, content, button, image }) => {
  if (!title && !content) return null

  return (
    <div className="my-12 md:my-[120px]">
      <div className="max-w-container mx-auto w-[100%] px-6">
        <div className="flex flex-col-reverse md:flex-row items-center gap-2 md:gap-16">
          <div className="flex-1 text-left">
            {title && (
              <h2 className="text-gray-850 text-3xl md:text-[2.75rem] leading-[42px] md:leading-[48px] font-bold mb-6">
                {title}
              </h2>
            )}
            {content && (
              <p className="text-gray-550 text-sm md:text-lg mb-8" 
          ...
          {image && (
            <div className="flex flex-1 w-full md:max-w-[400px]">
              <Image
